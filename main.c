    ...
    if(latchmenu==0)
        ...
        else if(latchmenu==1)
        {
          ...
          { 
            ...
            {
              p++;
              if(p==1){bawah+=10;if(bawah>99){bawah=0;}}
              else if(p==50){p=0;}
            }
            else if(push==2)
            {
              p++;
              if(p==1){bawah++;if(bawah>99){bawah=0;}}
              else if(p==50){p=0;}
            }
          ...
          { 
            ...
            {
              p++;
              if(p==1){atas+=10;if(atas>99){atas=0;}}
              else if(p==50){p=0;}
            }
            else if(push==2)
            {
              p++;
              if(p==1){atas++;if(atas>99){atas=0;}}
              else if(p==50){p=0;}
            }
            else if(push==3){atas=0;}
            else if(push==4){atas=99;}
          }
          else if(menu==4)
          {
